...
public class Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstaceState) {
        ...
        final NotaListAdapter adapter = new NotaListAdapter( new NotaListAdapter.NotaDiff(),
                view -> {
                    String notaCliclked =(view.getTag().toString());
                    Log.d("CLICKNOTA", notaCliclked);

                    Intent intent = new Intent(Principal.this,MostrarDetalles.class);
        ...
        notaViewModel.getAllNotas().observe( this,notas -> {
            adapter.submitList( notas );
        } );

        FloatingActionButton fab = findViewById( R.id.fab );
        fab.setOnClickListener( view -> {
            Intent intent = new Intent(Principal.this, NewNotaActivity.class);
